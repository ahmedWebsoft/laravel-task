    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="btn-group pull-right">
          <button class="btn btn-light-theme waves-effect waves-light" type="button" onclick="window.history.back(1)"><span
          ...
          <div class="portlet-body">
            ...
            <div class="card-box">
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <select parsley-trigger="change" required="" data-style="btn-white" name="role_id" class="form-control"
                      ...
                      <option value="{{$item->id}}"
                        {{
                        $isEdit && $item->id == $user->role_id ? 'selected' : ''}}>{{
                        $item->name }}</option>
                      @endforeach
                    </select>
                  </div>
                ...
                @if ($isEdit)
                  <div class="col-md-4">
                    <img src="{{Storage::disk('cms')->url($user->avatar ?? null)}}" alt="" style="max-width:150px">
                  </div>
                @endif
                <div class="col-md-6">
                  <div class="form-group">
