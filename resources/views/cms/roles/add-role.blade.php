    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="btn-group pull-right">
          <button class="btn btn-light-theme waves-effect waves-light" type="button" onclick="window.history.back(1)"><span class="btn-label"><i class="fa fa-arrow-left"></i></span>Go back</button>
        </div>
