                            ...
                            <div class="portlet">
                              ...
                              <div id="HomeMainTitle4" class="panel-collapse collapse">
                                <div class="portlet-body">
                                  @foreach($languages->where('default',1) as $default_language)
                                    <div class="col-sm-12">
                                      ...
                                      <div class="form-group">
                                        <input type="text" name="heading[]" class="sectionFourTitle form-control" required
                                          value= "{{$home->where('language_id',$default_language->id)->where('type', 4)->first()->heading}}" />                        
                                      </div>
                                    </div> 
                                    ...
                                    <div class="col-sm-12">
                                      ...
                                      <div class="custom-summernote">
                                        <textarea name="text[]" id="text" class="sectionFourDescription summernote" required>
                                          {{$home->where('language_id',$default_language->id)->where('type', 4)->first()->text}}
                                        </textarea>                        
                                      </div>
                                    </div>   
                                  ...
                                  <input type="hidden" name="language_id[]" value="{{$default_language->id}}" class="sectionFourLanguage_id">
                                  @endforeach
                                  <br>
                                    <!-- portlet -->
                                          ...
                                          <div class="portlet-body">
                                            ...
                                            <div class="card">
                                              ...
                                              <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                  <input type="text" name="heading[]" class="sectionFourTitle form-control" required
                                                    value= "{{$home->where('language_id',$language->id)->where('type', 4)->first()->heading}}" />                        
                                                </div>
                                              </div> 
                                              ...
                                              <div class="custom-summernote">
                                                <textarea name="text[]" class="sectionFourDescription summernote" required>
                                                  {{$home->where('language_id',$language->id)->where('type', 4)->first()->text}}
                                                </textarea>
                                              <input type="hidden" name="language_id[]" value="{{$language->id}}" class="sectionFourLanguage_id">
                                              </div>
                                            </div>
                                          </div>
                                            @endforeach
